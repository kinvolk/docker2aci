...
func (rb *RepositoryBackend) buildACIV2(layerID string, dockerURL *types.ParsedDockerURL, outputDir string, tmpBaseDir string, curPwl []string, compress bool) (string, *schema.ImageManifest, error) {
	...
	aciPath, aciManifest, err := common.GenerateACI(layerData, dockerURL, outputDir, layerFile, curPwl, compress)
	if err != nil {
